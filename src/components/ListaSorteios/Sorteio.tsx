...
export const Sorteio = () => {
  ...
  return <Box  padding={1} borderRadius={5} w="400px"  bg={"#222222"} cursor="pointer" _hover={{boxShadow: "rgba(255, 255, 255, 0.3) 0px 3px 4px 0px, rgba(255, 255, 255, 0.15) 0px 3px 6px 4px"}}>
