...
export const Sorteio = () => {
  ...
  return <Box border="2px solid #838383" padding={2} borderRadius={5} w="400px"  bg={"rgba(65,65,65,1)"} cursor="pointer" _hover={{boxShadow: "rgba(255, 255, 255, 0.3) 0px 3px 4px 0px, rgba(255, 255, 255, 0.15) 0px 3px 6px 4px"}}>
  <Flex  w="100%">
