...
import { IoClose, IoHomeOutline, IoPersonOutline, IoStarOutline, IoTrophyOutline, IoPersonAddOutline, IoCart } from 'react-icons/io5'
...
export const MenuMobile = ({ setIsExpanded, isExpanded }: { setIsExpanded: Function, isExpanded: boolean }) => {
    ...
    >
        ...
        <Flex marginTop={50} flexDirection="column" gap={5}>
            <Link href="/" style={{ display: 'flex', alignItems: 'center', gap: "30px" }} onClick={() => setIsExpanded(false)}>
            ...
            <Link href="/sorteio" style={{ display: 'flex', alignItems: 'center', gap: "30px" }} onClick={() => setIsExpanded(false)}>
            ...
            <Link href="/ganhadores" style={{ display: 'flex', alignItems: 'center', gap: "30px" }} onClick={() => setIsExpanded(false)}>
            ...
            {currentUser ? <Link href="/ganhadores" style={{ display: 'flex', alignItems: 'center', gap: "30px" }} onClick={() => setIsExpanded(false)}>
                <IconTitle IconComponent={IoCart} colorOne="#b6318a" colorTwo="#e765d6" />
                <Text color="white" fontSize={20}>Minhas Compras</Text>
            </Link> : <><Box style={{ display: 'flex', alignItems: 'center', gap: "30px", cursor: "pointer" }} onClick={onOpenisOpenSignUp}>
